...
class ShipStationHTTP(ShipStationBase):
	...
	def __init__(self, key: str, secret: str, debug: bool = False, timeout: int = 1) -> None:
	...
	def get(self, endpoint: str = "", payload: QueryParamTypes | None = None) -> Response:
	...
	def delete(self, endpoint: str = "", payload: QueryParamTypes | None = None) -> Response:
		with self.client as client:
