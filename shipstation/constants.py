...
# https://www.shipstation.com/docs/api/orders/create-update-order/
# advancedOptions
BILL_TO_PARTY_VALUES = Literal["my_account", "my_other_account", "recipient", "third_party"]
...
CONTENTS_VALUES = Literal["merchandise", "documents", "gift", "returned_goods", "sample"]
