...
def mocked_pagination():
	with mock(base_url="https://ssapi.shipstation.com", assert_all_called=False) as respx_mock:
		...
		respx_mock.get("/products", name="list_products_none").respond(200, json=LIST_PRODUCTS_NONE)
...
@mock
def test_list_products_ensure_params(ss: ShipStation, mocked_pagination: MockRouter) -> None:
